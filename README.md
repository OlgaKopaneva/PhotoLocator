...
3. Для просмотра работы чат-бота запусть бота по ссылке: https://t.me/OxfordExplorerBot (боту на распознание нужно отправить фото одной из 11 достопримечательностей Оксфорда - перечислены выше)  
